        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav me-auto">
                ...
                <?php if ($_SESSION['role'] === "Admin") : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../TP6_PAW/transaksi_form.php">Data Master</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="../../TP6_PAW/transaksi_form.php">Transaksi</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="../../TP7_PAW/">Laporan</a>
                    </li>
                ...
                <?php else : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../TP7_PAW/index.php">Laporan</a>
                    </li>
                <?php endif; ?>
