...
function simpanTransaksi($tanggal, $pelanggan_id, $kode_barang, $harga, $qty, $keterangan) {
    ...
    $queryTransaksi = "INSERT INTO transaksi (waktu_transaksi, keterangan, total, penlanggan_id)
    ...
    foreach ($kode_barang as $i => $kode) {
        ...
        $queryDetail = "INSERT INTO transaksi_detail (transaksi_id, barang_id, harga, qty)
